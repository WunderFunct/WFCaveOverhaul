...
public record RemoveCarversBiomeModifier(
	...
	public void modify(Holder<Biome> biome, Phase phase, ModifiableBiomeInfo.BiomeInfo.Builder builder) {
		...
		if (phase == BiomeModifier.Phase.REMOVE /*&& this.biomes.contains(biome)*/ && biome.is(BiomeTags.IS_OVERWORLD)) {
			...
			registeredCarvers.removeIf(registeredCarver -> this.carvers.contains(registeredCarver) && registeredCarver.unwrapKey().get().location().getNamespace().equals("minecraft"));
		}
	}
