...
public class InitCarverTypesFabric {
    ...
    public static void init() {
        ...
        Registry.register(Registry.CARVER, vanilla_canyon_rloc, VANILLA_CANYON);
        Registry.register(Registry.CARVER, caves_noise_distribution_rloc, CAVES_NOISE_DISTRIBUTION);
        ...
        BiomeModifications.addCarver(
                ...
                ResourceKey.create(Registry.CONFIGURED_CARVER_REGISTRY, canyons_rloc));

        BiomeModifications.addCarver(
                BiomeSelectors.foundInOverworld(),
                GenerationStep.Carving.AIR,
                ResourceKey.create(Registry.CONFIGURED_CARVER_REGISTRY, canyons_low_y_rloc));

        BiomeModifications.addCarver(
                BiomeSelectors.foundInOverworld(),
                GenerationStep.Carving.AIR,
                ResourceKey.create(Registry.CONFIGURED_CARVER_REGISTRY, caves_rloc));
