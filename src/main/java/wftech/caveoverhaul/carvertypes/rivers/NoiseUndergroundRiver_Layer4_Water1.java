...
public class NoiseUndergroundRiver_Layer4_Water1 extends NoiseUndergroundRiver {

	public static int MAX_CAVE_SIZE_Y = 20;
	public static float NOISE_CUTOFF_RIVER = 0.92f;
	private int seedOffset = 68;
	...
	public static NoiseUndergroundRiver INSTANCE = new NoiseUndergroundRiver_Layer4_Water1();
	public NoiseUndergroundRiver_Layer4_Water1() {
		super();
	}
	...
	protected void initNoise() {		
		...
		tnoise.SetSeed((int) FabricUtils.server.getWorldData().worldGenSettings().seed() + seedOffset + 2);
	...
	protected void initNoiseYLevel() {
		...
		FastNoiseLite tnoise = new FastNoiseLite();
		tnoise.SetSeed((int) FabricUtils.server.getWorldData().worldGenSettings().seed() + seedOffset);
		tnoise.SetNoiseType(NoiseType.OpenSimplex2); //SimplexFractal
	...
	protected void initShouldCarveNoise() {
		...
		FastNoiseLite tnoise = new FastNoiseLite();
		tnoise.SetSeed((int) FabricUtils.server.getWorldData().worldGenSettings().seed() + seedOffset + 1);
