...
public class NoiseUndergroundRiver_Layer3_Water extends NoiseUndergroundRiver {

	public static int MAX_CAVE_SIZE_Y = 20;
	public static float NOISE_CUTOFF_RIVER = 0.92f;
	private int seedOffset = 65;
	...
	public static NoiseUndergroundRiver INSTANCE = new NoiseUndergroundRiver_Layer3_Water();
	public NoiseUndergroundRiver_Layer3_Water() {
		super();
	}
