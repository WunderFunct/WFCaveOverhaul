...
public class NoiseUndergroundRiver_Layer7_Water extends NoiseUndergroundRiver {

	public static int MAX_CAVE_SIZE_Y = 20;
	public static float NOISE_CUTOFF_RIVER = 0.92f;
	private int seedOffset = 79;
	...
	public static NoiseUndergroundRiver INSTANCE = new NoiseUndergroundRiver_Layer7_Water();
	public NoiseUndergroundRiver_Layer7_Water() {
		super();
	}
