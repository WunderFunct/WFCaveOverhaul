...
public class NoiseUndergroundRiver_Layer6_Water extends NoiseUndergroundRiver {

	public static int MAX_CAVE_SIZE_Y = 20;
	public static float NOISE_CUTOFF_RIVER = 0.92f;
	private int seedOffset = 76;
	...
	public static NoiseUndergroundRiver INSTANCE = new NoiseUndergroundRiver_Layer6_Water();
	public NoiseUndergroundRiver_Layer6_Water() {
		super();
	}
