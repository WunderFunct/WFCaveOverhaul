...
public class NoiseUndergroundRiver_Layer3_Lava extends NoiseUndergroundRiver {

	public static int MAX_CAVE_SIZE_Y = 20;
	public static float NOISE_CUTOFF_RIVER = 0.92f;
	private int seedOffset = 62;
	...
	public static NoiseUndergroundRiver INSTANCE = new NoiseUndergroundRiver_Layer3_Lava();
	public NoiseUndergroundRiver_Layer3_Lava() {
		super();
	}
