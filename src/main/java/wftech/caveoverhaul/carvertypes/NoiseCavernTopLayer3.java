...
//was NoiseCavernBaseFixFromNewCaves NoiseCavernBaseSkipCarverVariant
public class NoiseCavernTopLayer3 extends NoiseCavernBaseFixFromNewCaves {

	/*
	 * 32 to 64
	 */
	public static float minY = 64;
	public static float maxY = 96;
	...
	public static int seedOffset = 11;
	
	private void initYNoise() {

		int seed = (int) FabricUtils.server.getWorldData().worldGenSettings().seed(); //(int) this.ctx.randomState().legacyLevelSeed();
		seed += seedOffset;
